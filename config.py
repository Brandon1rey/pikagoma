...
class DevelopmentConfig(Config):
    DEBUG = True
    # Usar la conexión MySQL con un valor predeterminado
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'mysql+pymysql://root:aguilarm78@localhost/pikagoma_db')
    # ⬆️ Actualizado con la contraseña correcta para MySQL
